<%-- 
    Document   : AddItem
    Created on : Sep 22, 2020, 9:18:18 AM
    Author     : My DELL
--%>
        ...
        <section class="cart_table_area p_100">
        	<div class="container">
				<div class="table-responsive">
                                    <form method="POST" action="ViewCartDetails.jsp">
					<table class="table">
						<thead>
                                                <td><h1>Buy Items</h1></td>
                                                <td></td>
							<tr>
                    <td>Username</td>
						...
						<tbody>
							...
							<tr>
								...
								<td>
                                        ...
                                        <table>
                                    <th>
                                    <td><input type="Submit" class="pest_btn" value="Add To Cart" ></td>
                                    </th>
                                        </table>
                                    </form>
				</div>
