<%-- 
    Document   : ViewItem
    Created on : Aug 19, 2020, 8:41:16 PM
    Author     : Admin
--%>
        	...
        	<div class="container">
        		<div class="banner_text">
        			...
        			<ul>
        				...
        				<li><a href="product-details.html">My Product</a></li>
        			</ul>
        		</div>
        	</div>
        </section>
        ...
        <section class="product_details_area p_100">
        	<div class="container">
        		<div class="row product_d_price">
        			<div class="col-lg-6">
                                    <div class="product_img"><img class="img-fluid" src="img/cake-feature/c-feature-1.jpg" width="450" height="450" alt=""></div>
        			</div>
        			<div class="col-lg-6">
          ...
          <%
                        ...
                        res=(List)request.getAttribute("item_result");
        		...
        		<div class="row product_d_price">
        			<div class="col-lg-6">
                                    <div class="product_img">
                                        <img class="img-fluid" src="img/cake-feature/c-feature-1.jpg" width="450" height="450" alt=""></div>
        			</div>
        			<div class="col-lg-6">
					
        				<div class="product_details_text">
                                           
                                        <h4><%out.println(it.next());%></h4>
