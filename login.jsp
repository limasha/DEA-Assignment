<%-- 
    Document   : login
    Created on : Sep 21, 2020, 2:59:54 PM
    Author     : dell
--%>
    ...
    <body>
        ...
        <section class="clean-block clean-form dark">
            <div class="container">
				...
				<br><br>
                    <h2 class="text-info" id="headings" >Login</h2>
                ...
                <form action="loginServlet" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control item" type="password" name="pass" required="" >
                    </div>

                    

                    <button class="btn btn-primary btn-block" id="addbtn"><input class="btn btn-primary btn-block" id="addbtn" type="submit" value="Login" name="login" ></button><br> <br>
