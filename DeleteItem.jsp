    ...
    <body>
        	...
        	<div class="container">
        		<div class="banner_text">
        			...
        			<ul>
        				...
        				<li><a href="our-team.html">Add product</a></li>
        			</ul>
        		</div>
        	</div>
        </section>
        ...
        <section class="clean-block clean-form dark">
            <div class="container">
				...
				<br><br>
                                <h2 class="text-info" id="headings" >Delete a Product</h2><br><br>
                  ...
                  <form action="DeleteItem_Servlet" method="post">
                    ...
                    <button class="btn btn-primary btn-block" id="addbtn"><input class="btn btn-primary btn-block" id="addbtn" type="submit" value="Delete" name="delete"></button><br> <br>
                    <button class="btn btn-primary btn-block" id="addbtn"><input class="btn btn-primary btn-block" id="addbtn" type="reset" value="Cancel" name="cancel"></button><br> <br>
                </form>
