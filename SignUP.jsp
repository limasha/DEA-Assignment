    ...
    <body>
        	...
        	<div class="container">
        		<div class="banner_text">
        			...
        			<ul>
        				...
        				<li><a href="our-team.html">Sign up</a></li>
        			</ul>
        		</div>
        	</div>
        </section>
        ...
        <section class="clean-block clean-form dark">
            <div class="container">
				...
				<br><br>
                    <h2 class="text-info" id="headings" >Sign up Form</h2>
                 ...
                 <form action="signupservlet" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control item" type="text" name="firstname" required="">
                    </div>
                    <div class="form-group">
                        <label for="name">Last Name </label>
                        <input class="form-control item" type="text" name="lastname" required="" >
                    </div>

                    <div class="form-group">
                        <label for="price">User Name</label>
                        <input class="form-control item" type="text" name="username" required="">
                    </div>

                    <div class="form-group">
                        <label for="details">Address</label>
                        <input class="form-control item" type="text" name="address" required="" >
                    </div>
                     
                     <div class="form-group">
                        <label for="details">Contact Number</label>
                        <input class="form-control item" type="number" name="contactnumber" required="" >
                    </div>
                     
                     <div class="form-group">
                        <label for="details">Email</label>
                        <input class="form-control item" type="text" name="email" required="" >
                    </div>
                     
                     <div class="form-group">
                        <label for="details">Password</label>
                        <input class="form-control item" type="text" name="password" required="" >
                    </div>
                     
                     <div class="form-group">
                        <label for="details">Confirm Password</label>
                        <input class="form-control item" type="text" name="confirmpassword" required="" >
                    </div>

                    <input class="btn btn-primary btn-block" id="addbtn" type="submit" value="Sign up" name="signup"><br> <br>
                    <input class="btn btn-primary btn-block" id="addbtn" type="reset" value="Clear" name="clear"><br> <br>
