<%-- 
    Document   : ViewCartDetails
    Created on : Sep 22, 2020, 10:26:44 AM
    Author     : My DELL
--%>
					...
					<table class="table">
						<thead>
							...
							<%
                                                            ...
                                                            String sql="select * from product where itemname='"+itemname+"'";
       			...
       			<div class="row cart_total_inner">
        			...
        			<div class="col-lg-5">
        				<div class="cart_total_text">
        					...
        					<div class="sub_total">
        						<h5>Sub Total <span><%=(price*quantity)%></span></h5>
        					</div>
        					<div class="total">
        						<h4>Total <span><%=(price*quantity)%></span></h4>
        					</div>
        					<div class="cart_footer">
        						<form method="POST" action="checkout.html">
        							<input type="submit" class="pest_btn" value="Checkout" >
        						</form>
        					</div>
        				</div>
        			</div>
