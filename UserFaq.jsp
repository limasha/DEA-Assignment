<%-- 
    Document   : UserFaq
    Created on : Sep 23, 2020, 7:12:52 AM
    Author     : My DELL
--%>
        		...
        		<div class="row">
        			<div class="col-md-9">
        				<div class="faq_left_form">
        					...
        					<form class="row contact_us_form" method="POST" action="AddQuestionServlet">
								<div class="form-group col-md-12">
									<input type="email" class="form-control" id="email" name="useremail" placeholder="Email Address*">
								</div>
								<div class="form-group col-md-12">
									<input type="text" class="form-control"  name="item" placeholder="Subject*">
								</div>
								<div class="form-group col-md-12">
									<textarea class="form-control" name="question"  rows="1" placeholder="Your Question*"></textarea>
								</div>
								<div class="form-group col-md-12">
									<input type="submit" value="submit" class="btn pest_btn form-control">
								</div>
							</form>
        				</div>
        			</div>
